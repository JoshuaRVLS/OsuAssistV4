...
namespace Osussist.src.gui
{
    public class AdvancedOptions : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            0,
            0});
            this.MinAreaNumeric.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            0,
            0});
            this.HitcircleRadiusNumeric.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.HitcircleRadiusSlider.Minimum = 1;
